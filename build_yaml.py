...
if __name__ == "__main__":
    ...
    b.add_sys("ball",ball, ball.State,vars={ball.Params: ball.Params()})
    b.add_sys("ball2", ball, ball.State(), ball.Params)
   ...
   # b.add_func(None,osdt.create_connections,connection_matrix=[["source","key","target"]],yaml_args=osdt.constructor.SAFE_ARGS)
